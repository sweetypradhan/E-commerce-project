...
const ShopNow = () => {
 ...
 const { data: allProducts, loading, error } = useFetch("http://localhost:5000/api/products", {
  method: "GET",
  headers: {
          ...
          {filteredProducts.map(product => (
            <li key={product.id} className='product-item'>
              ...
              {/* <Link to={`/product/${product.id}`} className='product-link'>
                ...
                <img src={images[0]} alt={images} className='product-image' />
...
//     headers: {
//       "Content-Type": "application/json",
//       authorization: `Bearer ${accessToken}`, // Adjust if needed
//     },
//   });
